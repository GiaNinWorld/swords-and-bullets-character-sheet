...
function Magic() {
    return (
        <div className="rounded-md bg-blue-100 py-4 overflow-hidden">
            <h1 className="px-3 py-2 mx-3 font-bold text-blue-800 tracking-wider bg-blue-200 rounded-md">Magic</h1>
            ...
            <div className="rounded-md bg-blue-100 py-4 m-2 overflow-hidden">
                <h1 className="px-3 py-2 mx-3 mb-2 font-bold text-blue-400  tracking-wider bg-blue-200 rounded-md">Mana</h1>
