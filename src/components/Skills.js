...
function Skills() {
    ...
    {
        // console.log(Object.keys(skillList), skillList, item);
    return (<li key={item} className="py-1 mb-2 mx-8 border-b-2 border-indigo-100">
    ...
    const renderSkills = () => titlesSkills.map(item =>
       { 
        // console.log(data.skills[item], item);
    return (<li key={item}>
